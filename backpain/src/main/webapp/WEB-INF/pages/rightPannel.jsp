...
<body>  
    ...
    <table width="727" border="0" cellpadding="0" cellspacing="0" class="tbl_Grid">
        ...
        <tr>
          <td style="padding-left: 10px;" bgcolor="#fff4d1">
       
			
			 <c:if test="${monitoringMessage  eq 'Yes'}">
			 <p>CALBA has registered you for monitoring.  A low back pain specialist will review your data and select the most appropriate symptoms for your daily monitoring.   CALBA will inform you by email when it is ready for you to start.</p>
			 </c:if>
            </td>
        </tr>
    </tbody></table>
