								...
								<script>
																				    $(document).ready(function () {
																				    	...
																				    	if(val==7){
																				    			...
																				    			if(leftSideScore>15){
																					    			document.getElementById('LeftSideAdjusted').innerHTML = "15";
																					    		...
																					    		if(rightSideScore>15){
																					    			document.getElementById('RightSideAdjusted').innerHTML = "15";
					...
					<c:if test="${question.parentEntityId ne null}">
						...
						<c:if test="${counting eq countingCompare}">
							...
							<td style="display: none;" rowspan="${counting}"><u
								style="color: green">${scoreVal}</u></td>
							<td style="display: none;" rowspan="${counting}"><u
								style="color: red">${scoreVal1}</u></td>
...
<td colspan="3">
	<table style="display: none">
		...
		<tr id="${boldRowCounter}"
			...
			<td style="display: none"><div id="HNPphaseNonRadScore">${TotalNonRadSum}</div></td>
			<td style="display: none"><div id="HNPphaseRadScore"></div>
				<input type="hidden" value="" id="HNPphaseRadScore" /></td>
			<td style="display: none"><div id="acuteRow"></div></td>
			<td style="display: none"><div id="earlyRow"></div></td>
			<td style="display: none"><div id="earlyMidRow"></div></td>
			<td style="display: none"><div id="lateMidRow"></div></td>
			<td style="display: none"><div id="lateRow"></div></td>
			<td style="display: none"><div id="recoveredRow"></div></td>
			<td style="display: none"><div id="chronicRow"></div></td>
			<td style="display: none"><div id="consultDrRow"></div></td>
		...
		<tr id="${boldRowCounter}"
			style="background-color:${count % 2 == 0 ? '#FFFBD6;' : 'White;' };">
			<td style="display: none"><div id="historyacuteRow">${historyValueHnp[0].acute}</div></td>
			<td style="display: none"><div id="historyearlyRow">${historyValueHnp[0].early}</div></td>
			<td style="display: none"><div id="historyearlyMidRow">${historyValueHnp[0].early_mid}</div></td>
			<td style="display: none"><div id="historylateMidRow">${historyValueHnp[0].late_mid}</div></td>
			<td style="display: none"><div id="historylateRow">${historyValueHnp[0].late}</div></td>
			<td style="display: none"><div id="historyrecoveredRow">${historyValueHnp[0].recovered}</div></td>
			<td style="display: none"><div id="historychronicRow">${historyValueHnp[0].dd1}</div></td>
			<td style="display: none"><div id="historyconsultDrRow">${historyValueHnp[0].dd2}</div></td>
		</tr>


		<tr id="${boldRowCounter}"
			style="background-color:${count % 2 == 0 ? '#FFFBD6;' : 'White;' };">
			<td style="display: none"><div id="finalacuteRow"></div></td>
			<td style="display: none"><div id="finalearlyRow"></div></td>
			<td style="display: none"><div id="finalearlyMidRow"></div></td>
			<td style="display: none"><div id="finallateMidRow"></div></td>
			<td style="display: none"><div id="finallateRow"></div></td>
			<td style="display: none"><div id="finalrecoveredRow"></div></td>
			<td style="display: none"><div id="finalchronicRow"></div></td>
			<td style="display: none"><div id="finalconsultDrRow"></div></td>
		</tr>
		<!-- End history table -->
	</table>
		...
		<table style="display: none">
			...
			<c:forEach items="${hnpPhaseValue}" var="hnpPhaseVal"
				...
				<c:choose>
					<c:when
						...
						<c:set var="boldRowStyle" value="border: 3px solid black" />
																  ...
																  $(document).ready(function () {
																     ...
																     var nonRad= document.getElementById('HNPphaseNonRadScore').innerHTML;
																      ...
																      if((nonRad>=${hnpPhaseVal.non_rad}) && (flag==false) && (rad>=${hnpPhaseVal.rad})){
																    	 ...
																    	 flag = true;
																    	 document.getElementById(${boldRowCounter}).style.backgroundColor='#FFFF00';
				...
				<td id="row" style="display: none">${hnpPhaseVal.non_rad}</td>
				<td style="display: none">${hnpPhaseVal.rad}</td>
				<td style="display: none">${hnpPhaseVal.acute}</td>
				<td style="display: none">${hnpPhaseVal.early}</td>
				<td style="display: none">${hnpPhaseVal.early_mid}</td>
				<td style="display: none">${hnpPhaseVal.late_mid}</td>
				<td style="display: none">${hnpPhaseVal.late}</td>
				<td style="display: none">${hnpPhaseVal.recovered}</td>
				<td style="display: none">${hnpPhaseVal.chronic}</td>
				<td style="display: none">${hnpPhaseVal.consultme}</td>
			...
			<c:if test="${historyValueHnp ne null}">
				<script>
																...
																document.getElementById('AcuteFinal').innerHTML=multiAcute;
																...
																document.getElementById('EarlyFinal').innerHTML=multiEarlyRow;
																...
																document.getElementById('EarlyMidFinal').innerHTML=multiEarlyRowMid;
																...
																document.getElementById('LateMidFinal').innerHTML=multilateMidRow;
																...
																document.getElementById('LateFinal').innerHTML=multilateRow;
																...
																document.getElementById('RecoveredFinal').innerHTML=multirecoveredRow;
																...
																document.getElementById('ChronicFinal').innerHTML=multichronicRow;
