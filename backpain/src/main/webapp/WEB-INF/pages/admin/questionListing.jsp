														...
														<table cellspacing="0" cellpadding="4" rules="rows"
															...
															<c:forEach items="${report.questionGroups}"
																...
																<c:forEach items="${questionGroup.description}"
																	...
																	<c:forEach items="${questionGroup.questions}" var="list" varStatus="minValue" begin="1" end="1">
																		...
																		<c:set var="counting1" value="0"/>
																		<c:set var="countingCompare" value="0"/>
																		<c:set var="countingCompare1" value="0"/>
																	...
																	<c:set var="counting1" value="${counting1 + 1}"/>
																	<c:set var="countingCompare" value="${countingCompare + 1}"/>
																	<c:set var="countingCompare1" value="${countingCompare1 + 1}"/>	
																...
																<c:forEach items="${questionGroup.questions}"
																	...
																	<tr
																		...
																		<c:if test="${counting1 eq countingCompare1}">
																		
																		<td style="border:1px solid black;" bgcolor="#990000" rowspan="${counting1}">
																		<div class='rotate'>
																		<font color="white">${questionGroup.description}
																		</font></div></td>
																	...
																	<%-- 	<c:set var="minValue" value="0"/>
																		...
																		<c:set var="specification" value="${specification + 1}"/>
