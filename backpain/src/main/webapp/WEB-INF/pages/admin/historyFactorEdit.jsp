...
<body>
	...
	<form:form method="post"
		action="${contextPath}/admin/historyFactor.html" commandName="form">
											...
											<tbody>
												<tr>
													<td height="25" colspan="2" align="left" valign="middle"
														class="tbl_red"><strong style="margin-left: 10px;">History
															factor</strong></td>
												</tr>
												<tr>
													<td colspan="2"><br /></td>
												...
												<tr>
													...
													<td colspan="1" style="width: 123px"><input
														type="text" id="dd1" name="dd1" value="${form[0].dd1}" /></td>
												...
												<tr>
													...
													<td colspan="1" style="width: 123px"><input
														type="text" id="dd2" name="dd2" value="${form[0].dd2}" /></td>
