...
<body>
 ...
 --%>
	...
	$( document ).ready(function() {
	   ...
	   var mostRecent1= document.getElementById('recent1').innerHTML;
	   var mostRecent2= document.getElementById('recent2').innerHTML;
	   ...
	   var recentArr = [mostRecent1, mostRecent2, mostRecent3,mostRecent4,mostRecent5];
       var recentMin = Math.min.apply(null, recentArr);
	   document.getElementById('finalRecent').innerHTML=recentMin;
	  
	   var current1= document.getElementById('current1').innerHTML;
	   var current2= document.getElementById('current2').innerHTML;
	   ...
	   var first1= document.getElementById('first1').innerText;
	   var first2= document.getElementById('first2').innerText;
	   ...
	   var firstArr = [first1, first2, first3,first4,first5];
